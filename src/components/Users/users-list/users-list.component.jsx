    ...
    return(
        <>
            <div className="bg-black w-full rounded-t-2xl text-white">
                <div className="py-6 px-10 flex justify-between items-center gap-1">
                    <div className="font-semibold text-lg w-[8rem]">Search Users:</div>
                    <div>
                        <div className="flex">
                            <div>
                                <input className="text-black w-[12vw] h-11 rounded-l-xl border border-black px-4" onChange={handleChange} type="search" id="search" name="search" placeholder="User Name"/>
                            </div>      
                            <div className="w-[2.75rem] p-1 align-middle bg-white border border-black rounded-r-xl">
